window.onload = function () {
    ...
    audio.autoplay=true
    setTimeout(() => {
        document.querySelector('#notebookglitch').classList.add('hidden')
    ...
    for (let yy = 42; yy <= 46; yy++) {
        for (let xx = 32; xx <= 42; xx++) {
            document.querySelector('.x'+xx+'.y'+yy).classList.add('computer')
        }
    }
    for (let yy = 43; yy <= 49; yy++) {
        for (let xx = 43; xx <= 48; xx++) {
            document.querySelector('.x'+xx+'.y'+yy).classList.add('computer')
        }
    }
    ...
    function CHANGESCREEN() {
        ...
        if (LASTSCREEN != SCREEN) {
            if (location=='home'){
                ...
                document.querySelector('#computerworking2').classList.remove('working')
                switch (SCREEN) {
                    case 1:
                    ...
                    case 2:
                        ...
                        document.querySelector('#computerworking').classList.remove('hidden')
                        document.querySelector('#computerworking2').classList.remove('hidden')
                        document.querySelector('#computerworking2').classList.add('working')
                        break;
                    case 4:
