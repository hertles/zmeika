...
<body>
    ...
    <img src="visual/world/notebook.png" alt="" class="background" id="notebook">
    <img src="visual/world/computer.png" alt="" class="background hidden" id="computer">
    <img src="visual/world/computerworking.png" alt="" class="background hidden" id="computerworking">
    <img src="visual/world/computerworking2.png" alt="" class="background hidden" id="computerworking2">
    ...
    <img src="visual/world/notebookglitch.gif" alt="" class="background" id="notebookglitch">
