...
<body>
    <div id='achievement' class='hidden'><img src="visual/endings/6.png" alt=""><at><atf><ah>Открыта новая концовка!<ab>1. Fat Ending</ab></atf></at></div>
    ...
    <audio id='friendsong1' preload="auto" src="sound/friendsong1.mp3"></audio>
    ...
    <div id='escmessage' class='message hidden'>
        <text style='display:inline-block;'>Нажмите Esc, чтобы выйти из диалога.</text>
        <img src="http://cdn.onlinewebfonts.com/svg/img_515480.png" alt="" style='display:inline-block;width:25px; height: 25px; position: absolute; right: 5px; bottom: 5px; filter:invert(1)'>
    </div>
    ...
    for ($i = 1; $i <= 360; $i++) {
        ...
        for ($j = 1; $j <= 60; $j++) {
            if ($i > 29) {
                ...
                } else if ($i == 58 || $j == 1 || $j == 60) {
                    echo '<td class="x' . $j . ' y' . $i . ' block secretblock hiddenblock hiddencell" onclick="removeblock(this)"></td>';
                } else if ($i == 195 && $j == 20)
                    echo '<td class="x' . $j . ' y' . $i . ' fakefood" Состав="Это даже не корм. Он проклят. Лучше его не трогать"></td>';
                else echo '<td class="x' . $j . ' y' . $i . ' secretcell hiddencell"></td>';
    ...
    <div id="titres" class="hidden">
        ...
        <br><br><br><br>
        <pre>
        <code id="htmlViewer" style="color:rgb(248, 248, 242);display:block;padding: .5em;"><span style="color:rgb(212, 208, 171); font-weight:400;">//document.querySelectorAll(&#x27;.x5.y5&#x27;).css</span>
