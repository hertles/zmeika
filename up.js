...
function GodInitialize(){
    ...
    questionvar[2] = [
        ...
        'Для этого достаточно просто <yellowtext>прыгнуть.</yellowtext>',
    ...
    questionvar[3] = [
        'Ты здесь потому что решил отказаться от своего корма.',
        'Не слушая свое тело, которое изнывало от голода по грехам.',
        'Теперь же от твоего тела осталась маленькая крупица.',
        'Но даже эта беспомощная оболочка тянет тебя вниз.',
        'continue'
    ]
    replic[0] = 'Здравствуй.'
    ...
    replic[3] = 'это <redtext>освободиться</redtext> от своей телесной оболочки.'
